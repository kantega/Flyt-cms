...
## Use transactions and READ_COMMITTED by default
When saving content a transaction may be used, but by default it is not used. When it was used READ_UNCOMMITTED was used.
