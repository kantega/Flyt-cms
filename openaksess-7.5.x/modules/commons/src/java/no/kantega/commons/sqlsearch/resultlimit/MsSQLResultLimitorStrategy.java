 ...
 *
 */
public class MsSQLResultLimitorStrategy extends ResultLimitorStrategyAdapter {

    public String limitFirstInSelect(SearchTerm searchTerm) {
        if(searchTerm.getMaxResults() != -1) {
            return "TOP " + searchTerm.getMaxResults();
        } else {
            return super.limitFirstInSelect(searchTerm);
        }
    }
}
