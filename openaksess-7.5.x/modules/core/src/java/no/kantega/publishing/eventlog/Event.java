...
public class Event {
    ...
    public static final String UPDATE_DISPLAY_PERIOD = "UPDATE_DISPLAY_PERIOD";
    ...
    public static final String FAILED_EMAIL_SUBMISSION = "FAILED_EMAIL_SUBMISSION";
    public static final String FAILED_LINK_EXTRACT = "FAILED_LINK_EXTRACT";

    public static final String FAILED_FORM_SUBMISSION = "FAILED_FORM_SUBMISSION";
    ...
    APPROVED, REJECTED, UPDATE_DISPLAY_PERIOD, SAVE_ATTACHMENT, DELETE_TOPIC, SAVE_TOPIC, DELETE_MULTIMEDIA, SAVE_MULTIMEDIA, SAVE_SITE, SET_PERMISSIONS, FAILED_LOGIN, FAILED_EMAIL_SUBMISSION, FAILED_FORM_SUBMISSION, FAILED_LINK_EXTRACT, EMAIL_SENT};
}
