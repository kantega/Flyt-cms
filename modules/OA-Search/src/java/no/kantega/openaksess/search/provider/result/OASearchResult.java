...
public class OASearchResult extends SearchResult {
     ...
     */
    public OASearchResult(int id, int securityId, String indexedContentType, String title, String description, String author, String url, int parentId, List<PathEntry> pathEntries) {
