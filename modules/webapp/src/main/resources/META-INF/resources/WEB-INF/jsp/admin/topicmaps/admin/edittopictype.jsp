    ...
    <form name="myform" action="EditTopicType.action" method="post">
        <admin:box>
            ...
            <div class="buttonGroup">
                ...
                <span class="button"><input type="button" class="cancel" onclick="window.location.href='ListTopicTypes.action?topicMapId=${topicMapId}'" value="<kantega:label key="aksess.button.cancel"/>"></span>
            </div>
        </admin:box>
    </form>
</kantega:section>
