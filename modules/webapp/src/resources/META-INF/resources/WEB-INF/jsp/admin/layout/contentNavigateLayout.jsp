...
<kantega:section id="head">
    ...
    <script type="text/javascript">
        ...
        properties.content['labels'] = {
			...
			linkcheckStatusUNKNOWN_HOST: '<kantega:label key="aksess.linkcheck.statuses.2" escapeJavascript="true"/>',
	        linkcheckStatusIO_EXCEPTION: '<kantega:label key="aksess.linkcheck.statuses.4" escapeJavascript="true"/>',
	        linkcheckStatusCONNECTION_TIMEOUT: '<kantega:label key="aksess.linkcheck.statuses.5" escapeJavascript="true"/>',
	        linkcheckStatusCIRCULAR_REDIRECT: '<kantega:label key="aksess.linkcheck.statuses.6" escapeJavascript="true"/>',
	        linkcheckStatusCONNECT_EXCEPTION: '<kantega:label key="aksess.linkcheck.statuses.7" escapeJavascript="true"/>',
	        linkcheckStatusCONTENT_AP_NOT_FOUND: '<kantega:label key="aksess.linkcheck.statuses.8" escapeJavascript="true"/>',
	        linkcheckStatusINVALID_URL: '<kantega:label key="aksess.linkcheck.statuses.9" escapeJavascript="true"/>',
	        linkcheckStatusATTACHMENT_AP_NOT_FOUND: '<kantega:label key="aksess.linkcheck.statuses.10" escapeJavascript="true"/>',
	        linkcheckStatusMULTIMEDIA_AP_NOT_FOUND: '<kantega:label key="aksess.linkcheck.statuses.11" escapeJavascript="true"/>',
