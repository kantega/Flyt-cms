...
<kantega:section id="body">
    ...
    <h1>
        <a class="linkexternal" href="http://opensource.kantega.no/aksess">OpenAksess</a> ${aksessVersion} (<kantega:label key="aksess.systeminfo.revision.aksess"/> ${aksessRevision})
    </h1>
                <pre id="Licence">
