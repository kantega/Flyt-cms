...
<html>
<head>
	<title>topicmaps/admin/index.jsp</title>
    <link rel="stylesheet" type="text/css" href="../../css/<%=skin%>.css">
</head>
<script language="Javascript">
function deleteTopicMap(id, name) {
    if (confirm("<kantega:label key="aksess.topicmaps.admin.confirmdelete"/> " + name + "?")) {
        location = "DeleteTopicMap.action?id=" + id;
    }
}

function editTopicMap(id) {
    location = "edittopicmap.jsp?id=" + id;
}
</script>
<body class="bodyWithMargin">
<table border="0" cellspacing="0" cellpadding="0" width="600">
    <tr class="tableHeading">
        <td><b><kantega:label key="aksess.topicmaps.admin.topicmap"/></b></td>
        <td><b><kantega:label key="aksess.topicmaps.admin.editable"/></b></td>
        <td>&nbsp;</td>
    </tr>
<%
        ...
        <tr class="tableRow<%=(i%2)%>">
            ...
            <td align="right">
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><a href="Javascript:editTopicMap(<%=topicmap.getId()%>)"><img src="../../bitmaps/common/buttons/mini_rediger.gif" border="0"></a></td>
...
%>
    <tr class="tableRow0">
        <td colspan="3" align="right"><a href="edittopicmap.jsp" class="button"><kantega:label key="aksess.topicmaps.admin.newmap"/></a></td>
    </tr>
</table>
</body>
</html>
