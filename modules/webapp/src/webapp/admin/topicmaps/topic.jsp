            ...
            %>
                    <table border="0">
                        <tr>
                            ...
                            <td><a href="Javascript:removeContent(<%=content.getId()%>)" class="button"><kantega:label key="aksess.button.slett"/></td>
                        </tr>
                    </table>
            <%
                }
        ...
        <td align="right">
            ...
            <table border="0">
                <tr>
                    ...
                    <td><a href="Javascript:removeRole('<%=role.getId()%>')" class="button"><kantega:label key="aksess.button.slett"/></td>
                </tr>
            </table>
            <%
                }
