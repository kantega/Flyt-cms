...
<html>
<head>
	<title>Emnekart</title>
</head>
<frameset cols="204,*" frameborder="0" border="0">
    <frameset rows="*,4">
    ...
    <frame name="content" src="topicmap.jsp?dummy=<%=new Date().getTime()%>" marginwidth="0" marginheight="0" scrolling="no">
</frameset>
</html>
