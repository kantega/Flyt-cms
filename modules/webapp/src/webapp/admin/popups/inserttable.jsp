...
<html>
<head>
	<title><kantega:label key="aksess.inserttable.title"/></title>
...
<body class="bodyWithMargin" onLoad="initValues()">
<form name="myform">
         ...
         <p>
            <a href="Javascript:doInsert()"><img src="../bitmaps/<%=skin%>/buttons/ok.gif" border="0"></a>&nbsp;&nbsp;<a href="Javascript:window.close()"><img src="../bitmaps/<%=skin%>/buttons/avbryt.gif" border="0"></a>
         </p>
</form>
</body>
</html>
