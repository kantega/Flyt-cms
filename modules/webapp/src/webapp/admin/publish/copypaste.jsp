    ...
    <c:choose>
        <c:when test="${isCopy && !pasteShortCut}">
            <c:if test="${allowDuplicate && allowCrossPublish}">
                <p>
                    <b><kantega:label key="aksess.copypaste.copy.choose"/></b>
                </p>
            </c:if>
            <table border="0">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <b><kantega:label key="aksess.copypaste.copy.treecopy"/> <i><c:out value="${selectedContentTitle}"/></i> <kantega:label key="aksess.copypaste.copy.treecopy2"/> <i><c:out value="${parentTitle}"/></i></b><br>
                ...
                <tr valign="top">
                    ...
                    <td>
                        <b><kantega:label key="aksess.copypaste.copy.textcopy"/> <i><c:out value="${selectedContentTitle}"/></i> <kantega:label key="aksess.copypaste.under"/> <i><c:out value="${parentTitle}"/></i></b><br>
...
%>
    <b><kantega:label key="aksess.copypaste.kategori"/>:</b>&nbsp;
...
<p>
   <a href="Javascript:doSubmit()"><img src="../bitmaps/<%=skin%>/buttons/ok.gif" border="0"></a>&nbsp;&nbsp;
