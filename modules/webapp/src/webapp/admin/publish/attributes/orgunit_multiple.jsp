    ...
    <td class="inpHeading">
        <table border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td><a href="Javascript:selectOrgunit(document.myform.<%=fieldName%>)"><img src="<%=request.getContextPath()%>/admin/bitmaps/common/buttons/mini_legg_til.gif" border="0"></a></td>
