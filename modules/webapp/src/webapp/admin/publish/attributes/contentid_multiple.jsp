...
<div class="buttonGroup">
    <a href="#" onclick="openaksess.editcontext.selectContent(document.myform.<%=fieldName%>, <%=maxitems%>, <%=attribute.getStartId(content)%>)" class="button" tabindex="<%=attribute.getTabIndex()%>"><span class="add"><kantega:label key="aksess.button.add"/></span></a>
