...
<div class="buttonGroup">
    <a href="Javascript:selectTopic(document.myform.<%=fieldName%>)" class="button select" tabindex="<%=attribute.getTabIndex()%>"><span><kantega:label key="aksess.button.velg"/></span></a>
