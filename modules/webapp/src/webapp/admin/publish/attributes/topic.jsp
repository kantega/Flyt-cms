...
<div class="buttonGroup">
    <a href="Javascript:selectTopic(document.myform.<%=fieldName%>, false)" class="button choose" tabindex="<%=attribute.getTabIndex()%>"><span><kantega:label key="aksess.button.choose"/></span></a>
