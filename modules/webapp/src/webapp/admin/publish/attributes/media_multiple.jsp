...
<div class="buttonGroup">
    <a href="#" onclick="openaksess.editcontext.selectMultimedia(document.myform.<%=fieldName%>, '')" class="button" tabindex="<%=attribute.getTabIndex()%>"><span class="add"><kantega:label key="aksess.button.add"/></span></a>
