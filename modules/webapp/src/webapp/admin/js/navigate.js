...
openaksess.search = {
    ...
    performSearch : function(query){
        ...
        if (searchAction) {
            ...
            $("#MainPane .infoslider").infoslider('option', {cssClasses: 'search', resizable: true, floated: false, height: '300px'}).infoslider('open', document.getElementById("SearchForm"), content);
        }
    },
