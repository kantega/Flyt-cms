 ...
 *
 */
public class RemoveAttachmentJob extends IndexJob {

    private String attachmentId;

    private Logger log = Logger.getLogger(getClass());
    public RemoveAttachmentJob(String attachmentId, String source) {
    ...
    public void executeJob(JobContext context) {
        ...
        try {
            ...
            Term deleteTerm = provider.getDeleteTerm(attachmentId);
