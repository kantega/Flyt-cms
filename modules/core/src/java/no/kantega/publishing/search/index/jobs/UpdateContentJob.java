 ...
 *
 */
public class UpdateContentJob extends IndexJob {

    private Logger log = Logger.getLogger(getClass());

    public UpdateContentJob(String contentId, String source) {
        super(contentId, source);
    }

    public void executeJob(JobContext context) {
        new RemoveContentJob(getContentId(), getSource()).executeJob(context);
        try {
