...
public class Event {
    ...
    APPROVED, REJECTED, UPDATE_DISPLAY_PERIOD, SAVE_ATTACHMENT, DELETE_TOPIC, SAVE_TOPIC, DELETE_MULTIMEDIA, SAVE_MULTIMEDIA, SAVE_SITE, SET_PERMISSIONS, FAILED_LOGIN, FAILED_EMAIL_SUBMISSION, FAILED_FORM_SUBMISSION, FAILED_LINK_EXTRACT};
}
