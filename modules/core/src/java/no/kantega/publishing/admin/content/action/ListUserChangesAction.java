...
public class ListUserChangesAction extends AbstractController {
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (username == null) {
            ...
            return new ModelAndView("/WEB-INF/jsp/admin/userchanges/userchanges.jsp", model);
            ...
            return new ModelAndView("/WEB-INF/jsp/admin/userchanges/userchanges-documents.jsp", model);
        }
    }
}