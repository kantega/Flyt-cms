...
public class UpdateSiteAction extends AbstractController {

    private HostnamesDao dao;
    private SiteCache siteCache;

    @Autowired
    public UpdateSiteAction(HostnamesDao dao, SiteCache siteCache) {
        this.dao = dao;
    ...
    public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (request.getMethod().equalsIgnoreCase("POST")) {
            ...
            return new ModelAndView("/WEB-INF/jsp/admin/sites/editsite.jsp", model);
        }
