...
public class RemoveCellspacingFilter extends XMLFilterImpl {

    public void startElement(String string, String localName, String name, Attributes attributes) throws SAXException {

        if(name.equalsIgnoreCase("table")) {
            // Sett cellspacing til 0
            String cellspacing = attributes.getValue("cellspacing");
            if (cellspacing != null) {
                attributes = HtmlFilterHelper.setAttribute("cellspacing", "0", attributes);
            }
        }
