...
public class SaveVersionInfoAction extends AbstractSaveContentAction {
    private static String SOURCE = "aksess.SaveVersionInfoAction";
    ...
    public ValidationErrors saveRequestParameters(Content content, RequestParameters param, ContentManagementService aksessService) {
        // Gjør ingenting, denne fanen har ingen egenskaper kan endres
