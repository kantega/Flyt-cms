...
public class ContentAliasDaoJdbcImpl extends JdbcDaoSupport implements ContentAliasDao {
    ...
    public Set<String> getAllAliases() {
        return new HashSet<>(getJdbcTemplate().queryForList("select lower(alias) from content, associations where content.contentId = associations.contentId and associations.IsDeleted = 0", String.class));
    }
}
