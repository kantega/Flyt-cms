...
public interface ContentManagementService {
    ...
    Content getContentDoNotLog(ContentIdentifier id) throws NotAuthorizedException, ContentNotFoundException;

    Content getContent(ContentIdentifier id) throws NotAuthorizedException, ContentNotFoundException;
     ...
     */
    Content checkOutContent(ContentIdentifier id) throws NotAuthorizedException, ObjectLockedException, ContentNotFoundException;

    Content getLastVersionOfContent(ContentIdentifier id) throws ContentNotFoundException, NotAuthorizedException;

    List<Content> getAllContentVersions(ContentIdentifier id) throws ContentNotFoundException, NotAuthorizedException;

    Content checkInContent(Content content, ContentStatus newStatus) throws NotAuthorizedException;

    Content createNewContent(ContentCreateParameters parameters) throws NotAuthorizedException;
     ...
     */
    Content copyContent(Content sourceContent, Association target, AssociationCategory category, boolean copyChildren) throws NotAuthorizedException;
     ...
     */
    void setContentVisibilityStatus(Content content, ContentVisibilityStatus newVisibilityStatus);
     ...
     * @throws NotAuthorizedException
     */
    Content setContentStatus(ContentIdentifier cid, ContentStatus newStatus, String note) throws NotAuthorizedException;
     ...
     * @throws NotAuthorizedException
     */
    void deleteContentVersion(ContentIdentifier id) throws NotAuthorizedException;
     ...
     */
    List<Content> getContentList(ContentQuery query, boolean getAttributes, boolean getTopics);
     ...
     */
    List<Content> getContentList(ContentQuery query) ;
     ...
     * @return Liste med innholdsobjekter
     */
    List<Content> getContentSummaryList(ContentQuery query);
     ...
     */
    void updateDisplayPeriodForContent(ContentIdentifier cid, Date publishDate, Date expireDate, boolean updateChildren) throws NotAuthorizedException;

    /**
     * Henter en liste over antall endringer gjort av brukere
     * @return Liste med innholdsobjekter
     */
    List<UserContentChanges> getNoChangesPerUser(int months);
     ...
     */
    List<PathEntry> getPathByAssociation(Association association);
     ...
     */
    void copyAssociations(Association source, Association target, AssociationCategory category, boolean copyChildren);
     ...
     */
    List<Content> deleteAssociationsById(List<Integer> associationIds, boolean deleteMultiple);
     ...
     */
    void modifyAssociation(Association association);
     ...
     */
    Attachment getAttachment(int id, int siteId) throws NotAuthorizedException;
     ...
     */
    void streamAttachmentData(int id, InputStreamHandler ish);
